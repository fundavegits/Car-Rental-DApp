    ...
    <div style={{ width: '100%' }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px" }}>
        ...
        <button 
          ...
          style={{ background: "linear-gradient(90deg, #7c3aed 0%, #db2777 100%)", border: "none", color: "white", padding: "8px 18px", borderRadius: "15px", cursor: "pointer", fontSize: "0.85rem", fontWeight: "bold" }}
        >
          View All
        </button>
      </div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "20px", width: "100%" }}>
        {rentals && rentals.length > 0 ? rentals.slice(0, 4).map((rental, index) => (
          <div key={index} style={{ background: "#1e1e24", padding: "20px", borderRadius: "12px", border: "1px solid #333", textAlign: "center" }}>
            ...
            <div style={{ padding: "6px", borderRadius: "8px", background: "rgba(239, 68, 68, 0.1)", color: "#ef4444", fontSize: "0.8rem", fontWeight: "bold", marginTop: "10px", border: "1px solid rgba(239, 68, 68, 0.2)" }}>
              ● Currently Rented
            </div>
          </div>
