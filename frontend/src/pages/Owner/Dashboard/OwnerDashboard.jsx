...
export default function OwnerDashboard() {
  ...
  return (
    <div className="page owner-page" style={{ background: "#0f0f12", minHeight: "100vh", padding: "20px" }}>
      ...
      {/* FIXED: Active Rentals Section (Full Width + Passing Data) */}
      <div className="section" style={{ width: '100%', marginBottom: '25px' }}>
        {/* We filter the 'cars' list to only send rented vehicles (status 1) */}
